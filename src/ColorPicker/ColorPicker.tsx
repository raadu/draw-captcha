    ...
    return (
        ...
        style={{width:`${width}px`, height: `${height}px`}}>
            ...
            <div className={colorPickerCSS.gridContainer}>
                <div 
                    className={colorPickerCSS.gridItem1} 
                    onClick={() => setStrokeStyle("red")}
                >
                </div>
                <div 
                className={colorPickerCSS.gridItem2} 
                onClick={() => setStrokeStyle("green")}
                >
                </div>
                <div
                className={colorPickerCSS.gridItem3} 
                onClick={() => setStrokeStyle("blue")}
                >
                </div>
                <div
                className={colorPickerCSS.gridItem4} 
